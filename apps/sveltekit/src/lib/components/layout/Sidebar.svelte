...
import {
    LayoutDashboard, Package, ClipboardCheck, FileText, ShieldAlert, KanbanSquare,
    ChevronLeft, Users, Settings, LogOut,
  } from '@lucide/svelte';
  ...
  const navItems: NavItem[] = [
    { label: 'Dashboard', icon: LayoutDashboard, href: '/app', roles: ['admin', 'project_manager', 'field_engineer', 'hse_officer', 'architect', 'procurement'] },
    { label: 'Deliveries', icon: Package, href: '/app/deliveries', roles: ['admin', 'procurement', 'field_engineer', 'project_manager'] },
    { label: 'Inspections', icon: ClipboardCheck, href: '/app/inspections', roles: ['admin', 'architect', 'field_engineer', 'project_manager'] },
    { label: 'Blueprints', icon: FileText, href: '/app/blueprints', roles: ['admin', 'architect', 'field_engineer', 'project_manager'] },
    { label: 'Safety', icon: ShieldAlert, href: '/app/safety', roles: ['admin', 'hse_officer', 'field_engineer', 'project_manager'] },
    { label: 'Kanban', icon: KanbanSquare, href: '/app/projects', roles: ['admin', 'project_manager', 'field_engineer', 'architect'] },
    { label: 'Users', icon: Users, href: '/app/users', roles: ['admin'] },
    { label: 'Settings', icon: Settings, href: '/app/settings', roles: ['admin', 'project_manager'] },
  ];
