...
export async function requireAuth(ctx: { auth: { getUserIdentity: () => Promise<any> }; db: { query: (name: string) => any } }): Promise<Doc<'users'>> {
...
export async function requireRole(
  ctx: { auth: { getUserIdentity: () => Promise<any> }; db: { query: (name: string) => any } },
  allowedRoles: Role[],
): Promise<Doc<'users'>> {
